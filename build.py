...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/identify_num/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/identify_num/archive/master.zip", tmp)
    file += "master"
